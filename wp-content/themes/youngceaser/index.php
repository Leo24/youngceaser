...
<!--	<script type="application/ld+json">{"@context":"http:\/\/schema.org","@type":"WebSite","@id":"#website","url":"http:\/\/youngceaser.com\/","name":"Neil Patel","potentialAction":{"@type":"SearchAction","target":"http:\/\/youngceaser.com\/?s={search_term_string}","query-input":"required name=search_term_string"}}</script>-->
...
<!--	<link rel="https://api.w.org/" href="http://youngceaser.loc/wp-json/">-->
<!--	<link rel="shortlink" href="http://youngceaser.loc/">-->
<!--	<link rel="alternate" type="application/json+oembed" href="http://youngceaser.loc/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fyoungceaser.com%2F">-->
<!--	<link rel="alternate" type="text/xml+oembed" href="http://youngceaser.loc/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fyoungceaser.com%2F&#038;format=xml">-->
	<style type="text/css">
...
<footer id="footer" role="contentinfo">
	<div class="inner">
		<div class="author">
			<p class="logo">
				<a href="http://youngceaser.loc/"><img src="<?php echo get_template_directory_uri().'/fonts/logo-white.svg';?>" width="155" height="17" alt="Neil Patel"></a>
			</p>
...
<script type="text/javascript">
	if (!window.TL_Const) var TL_Const = {
		"security": "a4e78f8fb7",
		"ajax_url": "\/\/youngceaser.com\/wp-admin\/admin-ajax.php",
		"forms": [],
