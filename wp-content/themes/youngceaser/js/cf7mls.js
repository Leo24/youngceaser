(function($){
    ...
    $(document).on('click', '.cf7mls_next', function(event) {
		...
		current_fs_number = parseInt( current_fs.attr( 'data-cf7mls-order' ) );
        ...
        .done(function(msg) {
            ...
            if (json.success) {
                ...
                */
				...
				$( '.popup-form .list li:nth-child(' + ( current_fs_number + 2 ) + ')' ).addClass( 'item-active' );
   ...
   // $(".cf7mls_back").click(function(){
	$( 'body' ).on( 'click', '.cf7mls_back', function() {	
		...
		$( '.popup-form .list li' ).removeClass( 'item-active' );
		$( '.popup-form .list li:nth-child(' + ( current_fs_number ) + ')' ).addClass( 'item-active' );
    ...
    function dhScrollTo(el) {
        if (cf7mls_object.scroll_step == "1") {
            $('html, body').animate({
