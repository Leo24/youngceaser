 ...
 */
function neilpatel_customize_register( $wp_customize ) {
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			...
			'render_callback' => 'neilpatel_customize_partial_blogname',
		) );
		$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
			'selector' => '.site-description',
			'container_inclusive' => false,
			'render_callback' => 'neilpatel_customize_partial_blogdescription',
		) );
	}
	...
	$wp_customize->add_setting( 'color_scheme', array(
		'default'           => 'default',
		'sanitize_callback' => 'neilpatel_sanitize_color_scheme',
		'transport'         => 'postMessage',
	) );

	$wp_customize->add_control( 'color_scheme', array(
		'label'    => __( 'Base Color Scheme', 'neilpatel' ),
		'section'  => 'colors',
		'type'     => 'select',
		'choices'  => neilpatel_get_color_scheme_choices(),
		'priority' => 1,
	) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_textcolor', array(
		'label'       => __( 'Header and Sidebar Text Color', 'neilpatel' ),
		'description' => __( 'Applied to the header on small screens and the sidebar on wide screens.', 'neilpatel' ),
		'section'     => 'colors',
	) ) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_background_color', array(
		'label'       => __( 'Header and Sidebar Background Color', 'neilpatel' ),
		'description' => __( 'Applied to the header on small screens and the sidebar on wide screens.', 'neilpatel' ),
		'section'     => 'colors',
	) ) );

	// Add an additional description to the header image section.
	$wp_customize->get_section( 'header_image' )->description = __( 'Applied to the header on small screens and the sidebar on wide screens.', 'neilpatel' );
}
add_action( 'customize_register', 'neilpatel_customize_register', 11 );

/**
 * Render the site title for the selective refresh partial.
 *
 * @since Twenty Fifteen 1.5
 * @see neilpatel_customize_register()
 *
 * @return void
 */
function neilpatel_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function neilpatel_customize_partial_blogdescription() {
 ...
 *
 * Can be filtered with {@see 'neilpatel_color_schemes'}.
 *
 ...
 */
function neilpatel_get_color_schemes() {
	/**
	 ...
	 * }
	 */
	return apply_filters( 'neilpatel_color_schemes', array(
		'default' => array(
			'label'  => __( 'Default', 'neilpatel' ),
			'colors' => array(
				'#f1f1f1',
				'#ffffff',
				'#ffffff',
...
if ( ! function_exists( 'neilpatel_get_color_scheme' ) ) :
/**
 ...
 */
function neilpatel_get_color_scheme() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	$color_schemes       = neilpatel_get_color_schemes();
...
endif; // neilpatel_get_color_scheme

if ( ! function_exists( 'neilpatel_get_color_scheme_choices' ) ) :
/**
 ...
 */
function neilpatel_get_color_scheme_choices() {
	$color_schemes                = neilpatel_get_color_schemes();
...
endif; // neilpatel_get_color_scheme_choices

if ( ! function_exists( 'neilpatel_sanitize_color_scheme' ) ) :
/**
 ...
 */
function neilpatel_sanitize_color_scheme( $value ) {
	$color_schemes = neilpatel_get_color_scheme_choices();
...
endif; // neilpatel_sanitize_color_scheme
 ...
 */
function neilpatel_color_scheme_css() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	...
	$color_textcolor_rgb         = neilpatel_hex2rgb( $color_scheme[3] );
	$color_sidebar_textcolor_rgb = neilpatel_hex2rgb( $color_scheme[4] );
	$colors = array(
	...
	$color_scheme_css = neilpatel_get_color_scheme_css( $colors );

	wp_add_inline_style( 'neilpatel-style', $color_scheme_css );
}
add_action( 'wp_enqueue_scripts', 'neilpatel_color_scheme_css' );
 ...
 * @since Twenty Fifteen 1.0
 */
function neilpatel_customize_control_js() {
	...
	wp_localize_script( 'color-scheme-control', 'colorScheme', neilpatel_get_color_schemes() );
}
add_action( 'customize_controls_enqueue_scripts', 'neilpatel_customize_control_js' );
 ...
 * @since Twenty Fifteen 1.0
 */
function neilpatel_customize_preview_js() {
	wp_enqueue_script( 'neilpatel-customize-preview', get_template_directory_uri() . '/js/customize-preview.js', array( 'customize-preview' ), '20141216', true );
}
add_action( 'customize_preview_init', 'neilpatel_customize_preview_js' );
 ...
 */
function neilpatel_get_color_scheme_css( $colors ) {
 ...
 * @since Twenty Fifteen 1.0
 */
function neilpatel_color_scheme_css_template() {
	$colors = array(
	...
	?>
	<script type="text/html" id="tmpl-neilpatel-color-scheme">
		<?php echo neilpatel_get_color_scheme_css( $colors ); ?>
	</script>
	<?php
}
add_action( 'customize_controls_print_footer_scripts', 'neilpatel_color_scheme_css_template' );
