						...
						'<form class="np-form" action="" method="post">'+
							...
							'<div class="step-1">'+
								...
								'<p class="p-field field-select-wrap">'+
									...
									'<select name="webinar" class="field field-select" required>'+
							...
							'<div class="step-2">'+
								...
								'<p class="p-field">'+
									...
									'<input class="field" type="text" name="name" value="" placeholder="Your First Name" required>'+
								
								'</p>'+
								
								'<p class="p-field">'+
								
									'<input class="field" type="email" name="email" value="" placeholder="Your Email Address" required>'+
